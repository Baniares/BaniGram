package com.nearsoft.banigram.test;
...
public class MainActivity extends ActionBarActivity implements OnInstagramTaskComplited {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        instagramJson.execute(getResources().getString(R.string.popular));
    }
